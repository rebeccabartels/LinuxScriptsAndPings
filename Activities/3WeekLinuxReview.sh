...
- Test your script by running: `bash ping_challenge.sh`.
...
- Use nano to create and open a file called `user_enum.sh`.

- Use a command expansion to write a loop that prints every username in the /home directory.
  - **Note**: Use `ls`.
...
- Use `tar` to create a bzip2 archive of your `Projects` directory, located in your home directory.
